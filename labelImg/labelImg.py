...
from labelImg.libs.constants import *
from labelImg.libs.utils import *
from labelImg.libs.settings import Settings
from labelImg.libs.shape import Shape, DEFAULT_LINE_COLOR, DEFAULT_FILL_COLOR
from labelImg.libs.stringBundle import StringBundle
from labelImg.libs.canvas import Canvas
from labelImg.libs.zoomWidget import ZoomWidget
from labelImg.libs.labelDialog import LabelDialog
from labelImg.libs.colorDialog import ColorDialog
from labelImg.libs.labelFile import LabelFile, LabelFileError, LabelFileFormat
from labelImg.libs.toolBar import ToolBar
from labelImg.libs.pascal_voc_io import PascalVocReader
from labelImg.libs.pascal_voc_io import XML_EXT
from labelImg.libs.yolo_io import YoloReader
from labelImg.libs.yolo_io import TXT_EXT
from labelImg.libs.create_ml_io import CreateMLReader
from labelImg.libs.create_ml_io import JSON_EXT
from labelImg.libs.ustr import ustr
from labelImg.libs.hashableQListWidgetItem import HashableQListWidgetItem
from labelImg.InferenceSettings import InferenceSettings
from qt_material import apply_stylesheet

__appname__ = 'CMS Annotation tool'
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, default_filename=None, default_prefdef_class_file=None, default_save_dir=None,parent=None):
        ...
        open = action('Add Config', self.open_file,
                      'Ctrl+O','', '')
        ...
        save = action(get_str('save'), self.save_file,
                      'Ctrl+S', '', get_str('saveDetail'), enabled=False)
        ...
        save_as = action(get_str('saveAs'), self.save_file_as,
                         'Ctrl+Shift+S', '', '', enabled=False)

        close = action(get_str('closeCur'), self.close_file, 'Ctrl+W', '', '')

        delete_image = action(get_str('deleteImg'), self.delete_image, 'Ctrl+Shift+D', '', '')


        reset_all = action(get_str('resetAll'), self.reset_all, None, '', '')
        ...
        create = action(get_str('crtBox'), self.create_shape,
                        'w', '', get_str('crtBoxDetail'), enabled=False)
        ...
        edit = action(get_str('editLabel'), self.edit_label,
                      'Ctrl+E', '', get_str('editLabelDetail'),
                      enabled=False)
        ...
        self.actions = Struct(save=save, save_format=save_format, saveAs=save_as, open=open, close=close, resetAll=reset_all, deleteImg=delete_image,
                            ...
                            #             None, color1, self.draw_squares_option),
                              ...
                              onLoadActive=(
                                open,  close, create, create_mode, edit_mode),
    ...
    def verify_image(self, _value=True):
    ...
    def open_file(self, _value=False):
        ...
        if values:
            ...
            self.statusBar().showMessage("New settings not saved. Press OK after")
